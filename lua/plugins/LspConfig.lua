...
vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(ev)
        ...
        vim.keymap.set('n', '<space>f', function()                              -- lsp格式化
            vim.lsp.buf.format { async = true }
        end, opts)
        vim.keymap.set('n', '<space>d', vim.lsp.buf.declaration, opts)              -- 查看: method textDocument/declaration
        vim.keymap.set('n', '<space>k', vim.lsp.buf.hover, opts)                    -- 查看: 悬停文档
        vim.keymap.set('n', '<space>i', vim.lsp.buf.implementation, opts)           -- 查看: 实现
        ...
        vim.keymap.set('n', '<space>s', vim.lsp.buf.references, opts)               -- 查看: 参考
